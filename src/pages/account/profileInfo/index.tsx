...
const ProfileSection: React.FunctionComponent<IProfile> = (props) => {
    ...
    <Grid className={classes.mrg} item xs={10} lg={3}>
      ...
      <Box p={1} alignContent="center" alignItems="center">
        <Tooltip title="Change Picture">
          <IconButton>
            <CameraEnhanceIcon
              style={{ width: 30, height: 30, color: "burlywood" }}
            />
          </IconButton>
        </Tooltip>
      </Box>
      ...
      <Box p={1} display="flex" flexDirection="row">
        <Box p={1} flexGrow={1} alignContent="flex-start">
          <Typography style={{ fontSize: 20 }}>Entertainment </Typography>
        </Box>
      ...
      <Box display="flex" flexDirection="row">
        <Box flexGrow={1} alignItems="flex-center">
          <Typography style={{ fontSize: 13, textAlign: "center" }}>
            <p>allthingsentertainmentag@gmail.com </p>
          </Typography>
        </Box>
      </Box>
      ...
      <SpringModal
        handleCloseModal={handleCloseModalLogout}
